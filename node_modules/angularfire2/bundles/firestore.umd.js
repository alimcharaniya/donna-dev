(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('firebase/firestore'), require('rxjs/observable/from'), require('rxjs/add/operator/map'), require('@angular/core'), require('angularfire2'), require('rxjs/Observable'), require('rxjs/operator/observeOn'), require('rxjs/add/operator/filter'), require('rxjs/add/operator/scan')) :
    typeof define === 'function' && define.amd ? define(['exports', 'firebase/firestore', 'rxjs/observable/from', 'rxjs/add/operator/map', '@angular/core', 'angularfire2', 'rxjs/Observable', 'rxjs/operator/observeOn', 'rxjs/add/operator/filter', 'rxjs/add/operator/scan'], factory) :
    (factory((global.angularfire2 = global.angularfire2 || {}, global.angularfire2.firestore = global.angularfire2.firestore || {}),global.firebase,global.Rx.Observable,global.Rx.Observable.prototype,global.ng.core,global.angularfire2,global.Rx,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype));
}(this, (function (exports,firebase_firestore,rxjs_observable_from,rxjs_add_operator_map,_angular_core,angularfire2,rxjs_Observable,rxjs_operator_observeOn,rxjs_add_operator_filter,rxjs_add_operator_scan) { 'use strict';
...
var AngularFirestoreCollection = (function () {
    ...
    AngularFirestoreCollection.prototype.valueChanges = function (events) {
        return this.snapshotChanges()
            .map(function (actions) { return actions.map(function (a) { return a.payload.doc.data(); }); });
    };
...
var AngularFirestore = (function () {
    function AngularFirestore(app, shouldEnablePersistence) {
        ...
        this.persistenceEnabled$ = shouldEnablePersistence ?
            rxjs_observable_from.from(app.firestore().enablePersistence().then(function () { return true; })) :
